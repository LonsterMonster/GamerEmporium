	...
	<?php
		...
		while($row = $res->fetch_array(MYSQLI_ASSOC)) {
                $_CONFIG['Brand'] = $row['Brand'];
					if(($_CONFIG['Brand'] == "Jakks Pacific") && ($_CONFIG['Amount'] >= "1")){
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../Shop/Video Games/Plug N Play/Jakks Pacific/<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../img/Games/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
