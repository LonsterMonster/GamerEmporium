  ...
  <body class="size-960">
				  ...
				  <li><a href="../../Shop/Video Games.php">Video Games</a>
				    <ul>
					  ...
					  <li><a href="../../Shop/Video Games/Consoles.php">Consoles</a>
						<ul>
						  <li><a href="../../Shop/Video Games/Consoles/JAKKS.php">Jakks Pacific</a></li>
						</ul>
					  </li>
					</ul>
				  </li>
	...
	<?php
		...
		$res = $stmt->get_result();
            ...
            if(($_CONFIG['Brand'] == "Playstation") && ($row['amount'] >="1")){
		
		?>
		  <div class="card" style="width:400px">
		    <a href="../../Shop/Video Games/Console/<?php echo $_CONFIG['Brand']?>.php"><img class="card-img-top" src="../../img/Games/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		  ...
		  <?PHP
			...
			if(($_CONFIG['Brand'] == "Nintendo") && ($row['amount'] >="1")){
		...
		?>
		  ...
		  <?PHP
			...
			if(($_CONFIG['Brand'] == "Xbox") && ($row['amount'] >="1")){
		...
		?>
		  ...
		  <?PHP
			...
			<div class="card-deck">
			<?PHP
			if(($_CONFIG['Brand'] == "ATARI") && ($row['amount'] >="1")){
		
		?>
		  <div class="card" style="width:400px">
		    <a href="../../Shop/Video Games/Consoles/<?php echo $_CONFIG['Brand']?>.php"><img class="card-img-top" src="../../img/Games/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		  ...
		  <?PHP
			...
			if(($row['Brand'] == "SEGA") && ($row['amount'] >="1")){
