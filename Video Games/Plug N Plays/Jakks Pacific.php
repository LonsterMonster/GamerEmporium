  ...
  <body class="size-960">
				  ...
				  <li><a href="../../../Shop/Video Games.php">Video Games</a>
				    <ul>
					  ...
					  <li><a href="../../../Shop/Video Games/Plug N Plays.php">Plug N Plays</a>
						<ul>
						  <li><a href="../../../Shop/Video Games/Plug N Plays/Jakks Pacific.php">Jakks Pacific</a>
						    <ul>
						      <li><a href="../../../Shop/Video Games/Plug N Plays/Jakks Pacific/Games.php">Games</a></li>
						    </ul>
						  </li>
						</ul>
					  </li>
	...
	<?php
		...
		while($row = $res->fetch_array(MYSQLI_ASSOC)) {
					...
					$_CONFIG['Console'] = $row['Console_Type'];
					
					if($_CONFIG['Brand'] == "Jakks Pacific"){
					$_CONFIG['Console'] = $row['Console'];
					$_CONFIG['Amount'] = $row['Amount'];
						if($_CONFIG['Console'] == "Plug N Play"){
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../Shop/Video Games/Plug N Plays/Jakks Pacific/Games/<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../img/Games/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
