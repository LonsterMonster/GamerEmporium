	...
	<?php
		...
		while($row = $res->fetch_array(MYSQLI_ASSOC)) {
				...
				$_CONFIG['Console'] = $row['Console'];
					if(($_CONFIG['Brand'] == "ATARI") && ($_CONFIG['Amount'] >= "1")){
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../Shop/Video Games/Console/ATARI/2600<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../img/Games/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
