	...
	<?php
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/Nintendo/Gameboy Color/Accessories.php"><img class="card-img-top" src="../../../../img/Brands/Nintendo/Gameboy Color/Accessories.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/Nintendo/Gameboy Color/Systems.php"><img class="card-img-top" src="../../../../img/Brands/Nintendo/Gameboy Color/Games.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/Nintendo/Gameboy Color/Games.php"><img class="card-img-top" src="../../../../img/Brands/Nintendo/Gameboy Color/Games.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
