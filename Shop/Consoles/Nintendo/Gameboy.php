	...
	<?php
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/Nintendo/Gameboy/Accessories.php"><img class="card-img-top" src="../../../../img/Brands/Nintendo/Gameboy/Accessories.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/Nintendo/Gameboy/Systems.php"><img class="card-img-top" src="../../../../img/Brands/Nintendo/Gameboy/Systems.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/Nintendo/Gameboy/Games.php"><img class="card-img-top" src="../../../../img/Brands/Nintendo/Gameboy/Games.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
