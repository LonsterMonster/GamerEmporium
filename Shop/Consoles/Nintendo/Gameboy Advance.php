	...
	<?php
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/Nintendo/Gameboy Advance/Accessories.php"><img class="card-img-top" src="../../../../img/Nintendo/Brands/Gameboy Advanced/Accessories.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/Nintendo/Gameboy Advance/Systems.php"><img class="card-img-top" src="../../../../img/Nintendo/Brands/Gameboy Advanced/Systems.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/Nintendo/Gameboy Advance/Games.php"><img class="card-img-top" src="../../../../img/Brands/Nintendo/Gameboy Advanced/Games.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
