	...
	<?php
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/Nintendo/Wii/Accessories.php"><img class="card-img-top" src="../../../../img/Brands/Nintendo/Wii/Accessories.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/Nintendo/Wii/Systems.php"><img class="card-img-top" src="../../../../img/Brands/Nintendo/Wii/Systems.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/Nintendo/Wii/Games.php"><img class="card-img-top" src="../../../../img/Brands/Nintendo/Wii/Games.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
