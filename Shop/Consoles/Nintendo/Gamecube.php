	...
	<?php
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/Nintendo/Gamecube/Accessories.php"><img class="card-img-top" src="../../../../img/Nintendo/Gamecube/Accessories.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/Nintendo/Gamecube/Systems.php"><img class="card-img-top" src="../../../../img/Nintendo/Gamecube/Systems.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/Nintendo/Gamecube/Games.php"><img class="card-img-top" src="../../../../img/Nintendo/Gamecube/Games.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
