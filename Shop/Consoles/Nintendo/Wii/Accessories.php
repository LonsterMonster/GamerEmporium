	...
	<?php
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../../Shop/Video Games/Consoles/Nintendo/Wii/Accessories/<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../../../img/Accessories/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
