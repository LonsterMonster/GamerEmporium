	...
	<?php
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../../Shop/Video Games/Consoles/Nintendo/Wii/Systems/<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../../../img/Systems/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
