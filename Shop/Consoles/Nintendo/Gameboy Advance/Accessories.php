  ...
  <body class="size-960">
	...
	<?php
		...
		while($row = $res->fetch_array(MYSQLI_ASSOC)) {
					...
					if($_CONFIG['Brand'] == "Nintendo"){
					$_CONFIG['Console'] = $row['Console'];
					$_CONFIG['Amount'] = $row['Amount'];
						if($_CONFIG['Console'] == "Gameboy Advance"){
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../../Shop/Video Games/Consoles/Nintendo/Gameboy Advance/Accessories/<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../../../img/Accessories/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
