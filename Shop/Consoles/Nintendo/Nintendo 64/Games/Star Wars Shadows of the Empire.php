...
$sdoubledotconnect = "../../../../../../";
$_CONFIG['Page'] = "Star Wars Shadows of the Empire";
    ...
    <div class="container">   
        <div class="col-md-12">
            <div class="media-container-row">
				...
				$id = "Star Wars Shadows of the Empire";
				...
				while($row = $res->fetch_array(MYSQLI_ASSOC)) {
						...
						if($_Product_Config['Games'] === "Star Wars Shadows of the Empire"){
				?>
			...
			while($row = $res->fetch_array(MYSQLI_ASSOC)) {
							...
							if ($_Product_CONFIG['Name'] === "Star Wars Shadows of the Empire"){
							?>
