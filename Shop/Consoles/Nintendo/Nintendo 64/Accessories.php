	...
	<?php
		...
		while($row = $res->fetch_array(MYSQLI_ASSOC)) {
					...
					$_CONFIG['Amount'] = $row['Amount'];
						if($_CONFIG['Console'] == "Nintendo 64"){
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../../Shop/Video Games/Consoles/Nintendo/Nintendo 64/Accessories/<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../../../img/Accessories/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
