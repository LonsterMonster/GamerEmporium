	...
	<?php
		...
		$res = $stmt->get_result();
		  while($row = $res->fetch_array(MYSQLI_ASSOC)) {
				...
				$_CONFIG['Console'] = $row['Console'];
					if(($_CONFIG['Brand'] == "Nintendo") && ($_CONFIG['Amount'] >= "1")){
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../Shop/Video Games/Console/Nintendo/Gamecube<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../img/Games/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		  ...
		  <?PHP
             ...
             if($_CONFIG['Console'] == "Gameboy"){
		
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../Shop/Video Games/Console/Nintendo/Gameboy<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../img/Games/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../Shop/Video Games/Console/Nintendo/Gameboy Color<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../img/Games/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../Shop/Video Games/Console/Nintendo/Gameboy Advance<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../img/Games/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../Shop/Video Games/Console/Nintendo/Nintendo 64<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../img/Games/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../Shop/Video Games/Console/Nintendo/Wii<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../img/Games/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
