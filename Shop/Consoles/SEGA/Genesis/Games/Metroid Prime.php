...
$sdoubledotconnect = "../../../../../../";
$_CONFIG['Page'] = "Monster Truck Madness 64";
        ...
        <div class="col-md-12">
            <div class="media-container-row">
				...
				while($row = $res->fetch_array(MYSQLI_ASSOC)) {
						...
						if($_Product_Config['Games'] === "Monster Truck Madness 64"){
				?>
			...
			while($row = $res->fetch_array(MYSQLI_ASSOC)) {
							...
							if ($_Product_CONFIG['Name'] === "Monster Truck Madness 64"){
							?>
