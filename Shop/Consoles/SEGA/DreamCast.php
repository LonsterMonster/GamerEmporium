  ...
  <body class="size-960">
	...
	<?php
		...
		while($row = $res->fetch_array(MYSQLI_ASSOC)) {
					...
					if($_CONFIG['Brand'] == "SEGA"){
					$_CONFIG['Console'] = $row['Console'];
						if($_CONFIG['Console'] == "DreamCast"){
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/SEGA/DreamCast/Accessories/<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../../img/Accessories/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/SEGA/DreamCast/Systems/<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../../img/Systems/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../../Shop/Video Games/Console/SEGA/DreamCast/Games/<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../../img/Games/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
