...
<html>
  ...
  <title>Gamer Emporium | Video Games</title>
...
img {
  ...
  <body class="size-960">
          ...
          <div class="top-nav s-12 l-10">
            <ul>
              ...
              <li><a href="../Shop.php">Shop</a>
                <ul>
				  <li><a href="../Shop/Video Games">Video Games</a>
				    <ul>
	...
	<?php
				...
				$sql = "SELECT * FROM $sql_table WHERE Shop_Type=?";
				...
				$res = $stmt->get_result();
					while($row = $res->fetch_array(MYSQLI_ASSOC)) {
						...
						$_CONFIG['Console_Type'] = $row['Console_Type'];
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../Shop/Video Games/Console.php"><img class="card-img-top" src="../img/Brands/Brandslogo.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
			...
			if($_CONFIG['Console_Type'] == "Plug N Play"){
		    ?>
		  <div class="card" style="width:400px">
		    <a href="../Shop/Video Games/Plug N Plays.php"><img class="card-img-top" src="../img/Brands/PlugNPlayLogo.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
