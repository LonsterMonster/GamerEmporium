...
<html>
  ...
  <body class="size-960">
	...
	<?php
		...
		$res = $stmt->get_result();
		  while($row = $res->fetch_array(MYSQLI_ASSOC)) {
				...
				$_CONFIG['Console'] = $row['Console'];
					if(($_CONFIG['Brand'] == "Xbox") && ($_CONFIG['Amount'] >= "1")){
                    
				    }
				}
        }
			
             if($_CONFIG['Console'] == "Xbox"){
		
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../Shop/Video Games/Console/Xbox/Xbox<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../img/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		  ...
		  <?PHP
             ...
             if($_CONFIG['Console'] == "Xbox 360"){
		
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../Shop/Video Games/Console/Xbox/Xbox 360<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../img/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
		...
		?>
		  <div class="card" style="width:400px">
		    <a href="../../../Shop/Video Games/Console/Xbox/Xbox ONE<?php echo $_CONFIG['Games']?>.php"><img class="card-img-top" src="../../../img/<?PHP echo $_CONFIG['Games']?>.png" alt="Card image"></a>
		  </div>
			<?php
			}
			else 
