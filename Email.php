...
<html>
  ...
  <title>Gamer Emporium | Email</title>
  ...
  <?php 
	...
	<div class="alert alert-success alert-dismissible">
      ...
      <strong>Subscribed!</strong> You are now Subscribed to our weekly Newsletter.
    </div>
  <?php
	}
	else
  ...
  ?>
	...
	<div class="container">
	  <div class="row">
		...
		<div class=".col-sm-4">
		  <head>
		    <p class="Right-21"><font size="20"><strong>Send Us an Email</strong> </font> </p>
		  </head>
